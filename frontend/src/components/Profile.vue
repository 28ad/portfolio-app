    ...
    <div class="flex flex-col items-center md:items-start">
        ...
        <div class="flex flex-col md:flex-row items-start w-full">
            ...
            <div class="flex flex-col items-center md:items-start w-full">
                ...
                <input v-model="newUsername" v-bind:placeholder="username" class="border border-black rounded-md pl-2 h-10 w-11/12 md:w-10/12 placeholder:text-black" type="text" name="username"
                    id="username">
            </div>
            ...
            <div class="flex flex-col items-center md:items-start w-full">
                ...
                <input
                    class="border border-gray-400 text-gray-400 rounded-md pl-2 h-10 w-11/12 md:w-10/12 cursor-not-allowed"
        ...
        <div class="flex flex-col md:items-start items-center w-full">
            ...
            <textarea v-model="newBio" v-bind:placeholder="bio" class="border-[1px] border-black w-11/12 rounded-md placeholder:text-black" name="bio" id="bio"
